...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                                    <dt>Account Name</dt>
                                    <dd>
                                        <asp:TextBox ID="NSAccountName" CssClass="form-control" runat="server"></asp:TextBox></dd>
                                </dl>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                                    ...
                                    <dd>
                                        <asp:TextBox ID="NSSettlementAccountNumber" CssClass="form-control" runat="server"></asp:TextBox></dd>
                                </dl>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                                    ...
                                    <dd>
                                        <asp:TextBox ID="SNRequesterNumber" CssClass="form-control" runat="server"></asp:TextBox>
                                    </dd>
                                </dl>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                                    ...
                                    <dd>
                                        <asp:TextBox ID="SNRequesterName" CssClass="form-control" runat="server"></asp:TextBox>
                                    </dd>
                                </dl>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <dl class="margin-sm-bottom">
                                    <dt>Request Stage</dt>
                                    <dd>
                                        <asp:DropDownList ID="SNRequestStage" runat="server" CssClass="RequestStage">
                                            <asp:ListItem Value="">Select Stage</asp:ListItem>
                                            <asp:ListItem>Unit/Deparment Head</asp:ListItem>
                                            <asp:ListItem>E-Business</asp:ListItem>
                                            <asp:ListItem>POS Unit Configuration</asp:ListItem>
                                            <asp:ListItem>POS Unit Interswitch/Value</asp:ListItem>
                                ...
                                <dl class="margin-sm-bottom">
                                    ...
                                    <dd>
                                        <div class="input-group">
                                            <input type="text" id="SNFrom" runat="server" placeholder="Start" style="width: 127.5px;" class="datepicker form-control" />
                                            <span class="input-group-addon">-</span>
                                            <input type="text" id="SNTo" runat="server" placeholder="End" style="width: 127.5px;" class="datepicker form-control" />
                                        </div>
                                    </dd>
                                </dl>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%= SNFrom.ClientID %> ').datepicker({
                dateFormat: "mm/dd/yy",
                onSelect: function (dateText) {
                    $('#<%= SNTo.ClientID %>').datepicker('option', 'minDate', dateText);
                }
            });

            $('#<%= SNTo.ClientID %> ').datepicker({
                dateFormat: "mm/dd/yy"
            });
        });
    </script>
